...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='bpgcoin.conf'
CONFIGFOLDER='/root/.bpgcoin'
COIN_DAEMON='/usr/local/bin/bpgcoind'
COIN_CLI='/usr/local/bin/bpgcoin-cli'
COIN_REPO='https://github.com/bpg-project/BPGCoin/releases/download/2.2.1.0/Ubuntu.16.x64.tar.gz'
SENTINEL_REPO='https://github.com/bpg-project/Sentinel.git'
COIN_NAME='BPGCoin'
COIN_PORT=19551
RPC_PORT=5500
